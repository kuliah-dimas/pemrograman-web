...
const EditMahasiswaPage = () => {
    ...
    useEffect(()=> {
      const fetchInitialData = async ()=> {
          try {
            const response = await axios.get("http://localhost/pemrograman-web/P1/read_by_id.php/4");
  ...
  const handleSubmit =  async(e) => {
    ...
    const apiEndpoint = `http://localhost/pemrograman-web/P1/update.php/${id}`;
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-50"
            required
          />
        </div>
        <div className="mb-4">
